...
public class ElevationService {
    ...
    public ElevationService() {
        ...
        webTarget = client.target(BASE_URI).path("elevation/json");
    }
     ...
     */
    public <T> T elevacion(Class<T> responseType, String locations, String sensor, String... optionalQueryParams) throws ClientErrorException {
        String[] queryParamNames = new String[]{"locations", "sensor"};
        String[] queryParamValues = new String[]{locations, sensor};
